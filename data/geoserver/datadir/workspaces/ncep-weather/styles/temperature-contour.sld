<?xml version="1.0" encoding="ISO-8859-1"?>
  <StyledLayerDescriptor version="1.0.0"
    ...
    <NamedLayer>
      <Name>contour_temp</Name>
      <UserStyle>
        <Title>Contour Temp</Title>
        <Abstract>Extracts contours from Temp</Abstract>
        <FeatureTypeStyle>
          <Transformation>
          ...
          <Rule>
            ...
            <TextSymbolizer>
              <Label>
                <ogc:PropertyName>Temperature___Ground_or_water_surface</ogc:PropertyName>
              </Label>
              <Font>

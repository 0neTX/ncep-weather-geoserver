...
# C_varatmos="lev_10_m_above_ground=on&lev_10_m_above_mean_sea_level=on&lev_100_mb=on&lev_200_mb=on&lev_300_mb=on&lev_400_mb=on&lev_500_mb=on&lev_600_mb=on&lev_700_mb=on&lev_800_mb=on&lev_900_mb=on&&lev_entire_atmosphere=on&lev_mean_sea_level=on&lev_surface=on&var_APCP=on&var_GUST=on&var_HGT=on&var_PRMSL=on&var_TCDC=on&var_TMP=on&var_UGRD=on&var_VGRD=on"
# wave variables 
...
C_atmossubregion="subregion=&leftlon=0&rightlon=360&toplat=90&bottomlat=-90"
C_wavesubregion="subregion=&leftlon=0&rightlon=360&toplat=90&bottomlat=-90"
...
C_predictionslist="f000 f006 f012"
